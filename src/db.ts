/**
 * SQLite database access layer for the GBA/APD MCP server.
 *
 * Schema:
 *   - decisions    — GBA/APD decisions, sanctions, and rulings
 *   - guidelines   — GBA/APD guidance documents, aanbevelingen, and recommandations

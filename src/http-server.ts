...
const TOOLS = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        query: { type: "string", description: "Search query in Dutch or French (e.g., 'cookies toestemming', 'Google')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Get a specific GBA/APD decision by reference number.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "GBA/APD decision reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search GBA/APD guidance documents: aanbevelingen/recommandations on cookies, CCTV, direct marketing, employee monitoring.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Dutch or French" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description: "Get a specific GBA/APD guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
